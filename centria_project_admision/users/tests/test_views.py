...
from centria_project_admision.users.models import User
from centria_project_admision.users.tests.factories import UserFactory
from centria_project_admision.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
